...
public class ZipUtils {
    ...
    public static void createZips(String[] name) {
        Arrays.stream(name).forEach(n -> {
                    String targetFolderPath = "/home/efggjjp/code/ddm/iota-dm-platform-config/subprojects/" + n + "/build/reports/project/dependencies/";
                    String newZipFilePath = "/home/efggjjp/Documents/" + n + ".zip";
                    try {
